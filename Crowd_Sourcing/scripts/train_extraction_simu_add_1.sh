...
do
    ...
    TASK='maAddVecCrowd+latent' #'maMulScoreCrowd+latent' 'maCatVecCrowd+latent'
...
for TASK in 'maAddVecCrowd+latent' #'maCatVecCrowd+latent'
do
  for dir in subset_50_50 subset_50_30_30 subset_50_15_15 #subset_5_5 subset_10_5_5 subset_15_5_5 subset_30_5_5 subset_50_5_5 subset_50_10_10 subset_50_15_15 subset_50_30_30 subset_50_50
  do
    echo == $dir ==
    for rs in 999 73 2
    do
