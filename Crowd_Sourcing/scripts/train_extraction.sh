...
CORPUS="/home/ron_data/ouyu/data/conll2003/ner/ner-mturk/pruned_mturk/ner_dataset_ma.pk"
...
SEL='latent'
bs=32
for TASK in 'maMulScoreCrowd+latent' #'maMulMatCrowd+maMulCRFCrowd+latent'
do
CPNAME=$DATASET"/Teachers_"$TASK
for rs in 999 73 2
do
